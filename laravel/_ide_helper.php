 ...
 * Generated for Laravel 5.4.32 on 2018-02-01.
 *
...
namespace App\Facades { 
    ...
    class PromocodesFacade {
         ...
         * @static 
         */ 
        public static function create($reward, $quantity = -1, $expire_date = null)
        {
            return \App\Helpers\Promocodes\Promocodes::create($reward, $quantity, $expire_date);
        }
         ...
         * @static 
         */ 
        public static function check($code, $email)
        {
            return \App\Helpers\Promocodes\Promocodes::check($code, $email);
        }
...
namespace  { 
    ...
    class ViewProducts extends \App\Helpers\ViewProducts {}

    class WishlistProducts extends \App\Helpers\WishlistProducts {}

    class CartProducts extends \App\Helpers\CartProducts {}

    class Image extends \Intervention\Image\Facades\Image {}

    class Promocodes extends \App\Facades\PromocodesFacade {}
