...
@section('content')
    ...
    <div class="sub-title" style="border: 0; font: inherit; font-size: 18px; font-weight: 500; margin: 0; margin-top: 15px; padding: 0; vertical-align: baseline;">Ваши просмотренные товары</div>

    @include('emails.component.product-list', ['products' => $view_products])
