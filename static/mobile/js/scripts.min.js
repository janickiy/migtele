...
$(function(){function t(){var t=$(".profile-type input:checked").val(),i=$(".for-juridical"),e=$(".for-individual");"0"==t?(i.slideDown("slow"),e.slideUp("slow")):(i.slideUp("slow"),e.slideDown("slow"))}function i(t){var i=$('.delivery-description[data-id="'+t+'"]');d.slideUp(),i.slideDown()}function e(){var t=$(".delivery-type input:checked").data("price"),i=$("#order-delivery-price"),e=$("#order-amount");t=t||0,i.text($.number(t,0,"."," "));var a=0;$(".amount-value:not(#order-amount, #order-discount)").each(function(){var t=parseInt($(this).text().replace(" ",""));a+=t}),e.text($.number(a,0,"."," "))}function a(t,i){var e=t.closest(".count"),a=e.find('input[name="quantity"]'),n=a.val()?parseInt(a.val()):0,o=e.find(".count-minus"),d=n+i;if(d<=0?o.addClass("disabled"):o.removeClass("disabled"),t.hasClass("disabled"))return!1;a.val(d),setTimeout(function(){a.closest(".submit-form").length&&a.closest("form").submit()},300)}$(".load-more").click(function(){var t=$(this).attr("data-url"),i=$(this),e=$('<li class="preload"></li>');return i.fadeOut(),$(".product-list__block ul").append(e),$.ajax({url:t,dataType:"HTML"}).done(function(t){var a=$(t).find(".product-list__block ul li"),n=$(t).find(".load-more"),o=n.attr("data-url");e.remove(),$(".product-list__block ul").append(a),o&&i.attr("data-url",o).fadeIn()}),!1});var n=85*$(window).width()/100,o=new Slideout({panel:document.getElementById("panel"),menu:document.getElementById("menu"),padding:n,tolerance:70,touch:!0});$(".toggle-button").click(function(){o.toggle()}),$(".owl-carousel:not(.product-images)").owlCarousel({margin:19,responsive:{0:{items:3}}}),$(".product-images").owlCarousel({margin:19,responsive:{0:{items:2}}}),$(".spoiler-open").click(function(){if($(this).hasClass("load-more"))return!1;$(this).parent().find(".spoiler").slideDown(),$(this).parent().find(".short-text").slideUp(),$(this).slideUp()}),$(".profile-type input").change(function(){t()}),$(".profile-type input").length&&t();var d=$(".delivery-description").hide();$(".delivery-type input").change(function(){i($(this).data("id")),e()}),i($(".delivery-type input:checked").data("id")),e(),$(".count-minus").click(function(){a($(this),-1)}),$(".count-plus").click(function(){a($(this),1)}),$(".search-form").submit(function(){var t=$(this).find('input[name="search_text"]').val();return location.href="/search/"+t,!1}),$(".open-modal").click(function(t){var i=$(this).attr("href");if(window.location.hash=i,$(this).data("product_id")){$(i).find('input[name="product_id"]').val($(this).data("product_id"))}return $(this).modal({fadeDuration:120}),!1}),window.location.hash&&($(window.location.hash).modal({fadeDuration:120}),"#cart-modal"==window.location.hash&&display_modal_cart()),$("#alert-success").length&&$("#alert-success").iziModal({icon:"icon-check",title:" ",headerColor:"#00af66",width:600,timeout:5e3,timeoutProgressbar:!0,transitionIn:"fadeInDown",transitionOut:"fadeOutUp",autoOpen:1,pauseOnHover:!0}),$(".payment-titles span").click(function(){var t=$(this).data("id"),i=$(this).closest(".payment-block-wrapper"),e=i.find(".payment-titles"),a=i.find(".payment-texts");a.find(">div").hide(),e.find("span").removeClass("active"),e.find('span[data-id="'+t+'"]').addClass("active"),a.find('div[data-id="'+t+'"]').fadeIn("slow")}),"#pay"==location.hash&&$(".payment-titles span[data-id='1']").click()});