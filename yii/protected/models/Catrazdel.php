...
/**
 * This is the model class for table "{{catrazdel}}".
 *
 * The followings are the available columns in table '{{catrazdel}}':
 * @property string $id
 ...
 */
class Catrazdel extends CActiveRecord implements ClickCounterAble
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, name, text, hide, sort, title, keywords, description', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return Catrazdel the static model class
	 */
