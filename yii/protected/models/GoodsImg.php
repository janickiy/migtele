 ...
 *
 * The followings are the available columns in table '{{goods_img}}':
 * @property string $id
...
class GoodsImg extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('id_goods, text', 'required'),
			array('id_goods, sort', 'length', 'max'=>10),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, id_goods, text, sort', 'safe', 'on'=>'search'),
		);
	}
