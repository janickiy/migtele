...
$this->breadcrumbs=array(
	...
	$model->name=>array('/'.Yii::app()->language.'/admin/viewCurrency',"id" => $model->id),
	'Update',
);
...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'stock',array('size'=>60,'maxlength'=>256)); ?>
	...
	<?
		/*foreach($model->crossRates as $crossRate){			
			echo '<div class="row">';
			echo $crossRate->fromCurrency->briefname.'-'.$crossRate->toCurrency->briefname.': ';
			echo $form->textField($crossRate,'value',array('size'=>60,'maxlength'=>256));
			echo $form->error($crossRate,'value');
			echo '</div>';
		}
		*/
	?>
